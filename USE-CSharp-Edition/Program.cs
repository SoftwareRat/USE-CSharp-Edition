...
namespace USEwithoutCMD
{
    class Program
    {
        ...
        static void Main()
        {
            string USEversion = "Version 4.9";
            string Edition = " DEBUG";
            ...
            else
            {
                ...
                if (File.Exists(@"C:\Users\kiosk\AppData\Local\Temp\BackupNeeded.ini") == true)
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.Black;
                    Console.WriteLine("Servermode: BACKUP");
                    Console.ResetColor();
                } 
                else
                {
                    ...
                    Console.ForegroundColor = ConsoleColor.Black;
                    Console.WriteLine("Servermode: NORMAL");
                    Console.ResetColor();
                }
                Console.WriteLine(" ");
                ...
                //Saving Firefox userdata
                if (Directory.Exists("‪C:\\Users\\kiosk\\AppData\\Local\\Ubisoft Game Launcher\\spool\\firefox_userdata_gfn") != true)
                {
                    Directory.CreateDirectory("‪C:\\Users\\kiosk\\AppData\\Local\\Ubisoft Game Launcher\\spool\\firefox_userdata_gfn");
                }
                JunctionPoint.Create(@"C:\Users\kiosk\AppData\Roaming\Mozilla", "‪C:\\Users\\kiosk\\AppData\\Local\\Ubisoft Game Launcher\\spool\\firefox_userdata_gfn", true /*overwrite*/);
                ...
                Thread.Sleep(8500);
                Process.Start("taskkill", "/F /IM setup.exe");
                p.WaitForExit();
                ...
                var startshell = Process.Start(@"C:\\Users\\kiosk\\AppData\\Local\\Taskbar\\start.bat");
